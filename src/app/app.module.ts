...
@NgModule({
  declarations: [
    AppComponent,
    HeaderComponent,
    GameComponent, BoardComponent, SettingsComponent, ColorsRowComponent, ColorDotComponent, HintComponent, ColorCodeComponent, FooterComponent, AvailableColorsComponent
  ],
  imports: [
    BrowserModule
  ],
